package main.java.code.Scrollbars.src.blobs.view;

import main.java.code.Scrollbars.src.blobs.controller.IBlobController;
...
public class BlobView extends JFrame implements IBlobView {
  ...
  IBlobController controller;


  public BlobView(int width, int height, IBlobController controller) {
    super();
  ...
  class MyPanel extends JPanel {
    ...
    public void paintComponent(Graphics g) {
      ...
      List<Blob> blobs = controller.getBlobs();
